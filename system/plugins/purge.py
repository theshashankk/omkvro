...
@xd.on(events.NewMessage(pattern="^/purge"))
async def purge(event):
    ...
    try:
        ...
        await xd.delete_messages(chat, event.message.id)
...
@xd.on(events.NewMessage(pattern="^/del$"))
async def delete_msg(event):
    ...
    rm = [msg, to_delete]
    await xd.delete_messages(chat, rm)
